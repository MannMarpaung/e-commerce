    ...
    <section class="bg-gray-100 py-8 px-4">
        <div class="container mx-auto">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{ route('detail.product', $product->slug) }}" aria-label="current-page">{{ $product->name }}</a>
                </li>
            </ul>
        </div>
    </section>
                            ...
                            <div class="px-2">
                                <div class="item {{ $loop->first }}"
                                    ...
                                    <img src="{{ $item->exists() ? url('storage/product/gallery', $item->image) : '' }}"
                                        alt="product" class="object-cover w-full h-full rounded-lg" />
                                </div>
                            </div>
                        @endforeach
                    </div>
